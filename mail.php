...
$to = "alberto@bananamediainc.com, alberto.alvarado9414@gmail.com";
        ...
        echo  (mail($to, $Subject, $Mensaje, $headers)) ? "Message sent!" : "Mailer Error" ;
